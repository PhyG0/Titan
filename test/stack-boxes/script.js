...
import { PositionalCorrection, Resolve } from '../../2PS/core/collision/resolution.js'
...
for(let i = 0; i < noOfBoxes; i++) {
    let circle = new Rectangle(
        new Vector(200, -i * boxSize + 250), boxSize, boxSize
    )
    objects.push(circle);
}
